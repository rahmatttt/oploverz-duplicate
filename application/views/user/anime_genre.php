                ...
                <div class="col-12">
                    ...
                    <div class="row mt-2">
                        <div class="col-11">
                            ...
                            <span class="small text-secondary"><?= base_url() ?>/user/anime_genre/<?= $row['no_genre'] ?></span><br>
                            <p><?= substr($row['deskripsi'],0,200) ?>....</p>
                        </div>
                        <div class="col-1">
                            <img src="<?= base_url() ?>assets/gambar/<?= $row['gambar'] ?>" class="img-fluid">
                        </div>                        
                    </div>
                    <hr>
                    <?php
